...
public class StringBasedIdSerializer<TId> : NullableClassSerializerBase<TId>
    where TId : class, IConvertibleId<TId, string>
{
    ...
    {
        context.Writer.WriteString(value.ToValue());
    }
}
